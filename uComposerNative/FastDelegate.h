...
#undef FASTDELEGATE_USESTATICFUNCTIONHACK
	...
	{
	private:
		typedef void(*StaticFunctionPtr)(Params... args);
		typedef void(*UnvoidStaticFunctionPtr)(Params... args);
		typedef void(detail::GenericClass::*GenericMemFn)(Params... args);
	...
	public:
		...
		FastDelegateN(Y *pthis, void(X::* function_to_bind)(Params... p))
		{
			m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
		}

		template < class X, class Y >
		inline void bind(Y *pthis, void(X::* function_to_bind)(Params... p))
		{
			m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
		}
		...
		template < class X, class Y >
		FastDelegateN(const Y *pthis, void(X::* function_to_bind)(Params... p) const)
		{
			m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
		}

		template < class X, class Y >
		inline void bind(const Y *pthis, void(X::* function_to_bind)(Params... p) const)
		{
			m_Closure.bindconstmemfunc(detail::implicit_cast<const X *>(pthis), function_to_bind);
		}
		...
		FastDelegateN(void(*function_to_bind)(Params... p))
		{
			bind(function_to_bind);
		}

		// for efficiency, prevent creation of a temporary
		void operator = (void(*function_to_bind)(Params... p))
		{
			bind(function_to_bind);
		}

		inline void bind(void(*function_to_bind)(Params... p))
		{
			m_Closure.bindstaticfunc(this, &FastDelegateN::InvokeStaticFunction, function_to_bind);
		}

		// Invoke the delegate
		void operator() (Params... p) const
		{
			(m_Closure.GetClosureThis()->*(m_Closure.GetClosureMemPtr()))(p...);
		}
	...
	private:	// Invoker for static functions
		void InvokeStaticFunction(Params... p) const
		{
			(*(m_Closure.GetStaticFunction()))(p...);
		}
	};
